...
public class ReadResultsForSharingTask extends AsyncTask<String, Void, String>  {
    ...
    public ReadResultsForSharingTask(ShareQuizzes activity) {
    ...
    protected String doInBackground(String[] params) {      //Username | Code
        ...
        getfiles = activity.getQuizNames();
    ...
    protected void onPostExecute(String o) {
        if (o != null && o.equals("true")) {
           activity.setQuizResult(results);
